...
export const RENDER_QUALITY_PRESETS = Object.freeze({
  performance: createPreset({
    ...
    terrainSegments: [128, 64, 32],
    terrainBudgetMs: 1.5,
    vegetation: [90, 420, 150, 6],
    grassDistances: [16, 40, 90],
    grassRatios: [0.6, 0.18, 0.03],
    grassFadeDistance: 6,
    grassBudgetMs: 0.75,
    treeBudgetMs: 0.75,
    water: ['environment', 0.5, 0, false, 0, 'packed', 'low'],
    antiAliasing: 'fxaa',
  ...
  balanced: createPreset({
    ...
    terrainSegments: [256, 128, 64, 32],
    terrainBudgetMs: 2,
    vegetation: [110, 760, 220, 8],
    grassDistances: [28, 72, 150],
    grassRatios: [1, 0.25, 0.06],
    grassFadeDistance: 8,
    grassBudgetMs: 1,
    treeBudgetMs: 1,
    water: ['probe', 0.5, 0, true, 2, 'high', 'medium'],
    antiAliasing: 'smaa',
  ...
  quality: createPreset({
    ...
    terrainSegments: [256, 128, 64, 32],
    terrainBudgetMs: 2.5,
    vegetation: [180, 1040, 320, 10],
    grassDistances: [36, 100, 220],
    grassRatios: [1, 0.4, 0.1],
    grassFadeDistance: 10,
    grassBudgetMs: 1.25,
    treeBudgetMs: 1.25,
    water: ['planar', 0.5, 2, true, 3, 'high', 'high'],
    antiAliasing: 'smaa',
    aerialPerspective: true,
    gtao: true,
    gtaoSamples: 12,
...
function createPreset({
  ...
  return Object.freeze({
    ...
    grass: Object.freeze({
      ...
      fadeDistance: grassFadeDistance,
    ...
    water: Object.freeze({
      ...
      refractionPixels: water[4],
      waterInfoPrecision: water[5],
      normalDetail: water[6],
    }),
