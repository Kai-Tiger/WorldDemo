...
build(
    ...
    [
        ...
        ("ds-harness-vista.png", "DeepSeek V4 Pro High", "DeepSeek Harness · :4192"),
        ("deepseek-v4-pro-0814-codex-vista.png", "DeepSeek V4 Pro 0814", "Codex · :4193"),
        ("gpt-5-6-luna-medium-vista.png", "GPT 5.6 Luna Medium", "gpt-luna"),
        ("glm-5-2-vista.png", "GLM 5.2", "feat/GLM-5-2"),
        ("pro-0813-vista.png", "DeepSeek V4 pro 0813", "pro-0813"),
    ],
    panel=(640, 360),
)
...
build(
    ...
    [
        ...
        ("ds-harness-waterfall.png", "DeepSeek V4 Pro High", "DeepSeek Harness · fixed shot"),
        ("deepseek-v4-pro-0814-codex-waterfall.png", "DeepSeek V4 Pro 0814", "Codex · fixed shot"),
        ...
        ("pro-0813-waterfall.png", "DeepSeek V4 pro 0813", "fixed shot"),
    ],
    panel=(480, 270),
)
...
build(
    ...
    [
        ...
        ("ds-harness-spawn.png", "DeepSeek V4 Pro High", "Harness · visible; WASD failed"),
        ("deepseek-v4-pro-0814-codex-spawn.png", "DeepSeek V4 Pro 0814", "Codex · T-pose; WASD failed"),
        ...
        ("pro-0813-spawn.png", "DeepSeek V4 pro 0813", "visible player; WASD failed"),
    ],
    panel=(480, 270),
)
