...
build(
    ...
    [
        ...
        ("ds-harness-vista.png", "ds-harness", "3763882 · :4192"),
...
build(
    ...
    [
        ...
        ("ds-harness-waterfall.png", "ds-harness", "verified live fixed shot"),
...
build(
    ...
    [
        ...
        ("ds-harness-spawn.png", "ds-harness", "visible player; WASD failed"),
